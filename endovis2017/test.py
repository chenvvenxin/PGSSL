...
if __name__ == "__main__":
    ...
    with open('endovis2017/test_path_endovis2017.txt', 'r') as m:
        ids = m.read().splitlines()
    root_path = '' # path of dataset1fixed
    output_folder = 'endovis2017/output'
    checkpoint = torch.load('endovis2017/best_endovis2017.pth')
    
    data_transform = transforms.Compose([
        transforms.Resize((714, 1274)),  # (546, 966) (1078, 1918)
        transforms.ToTensor(),
    ...
    for idd in ids:
        ...
        output_filename = os.path.join(idd.split(' ')[0][-7:-4] + '_pred.jpg')
